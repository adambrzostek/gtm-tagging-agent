...
const SUGGESTED_PROMPTS = [
  "Wylistuj moje kontenery GTM",
  "Pokaż tagi w moim kontenerze",
  "Sprawdź, czy tagi GTM są poprawnie skonfigurowane",
  "Jakie triggery są skonfigurowane w moim workspace?",
];
