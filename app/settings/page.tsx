      ...
      >
        <div className="flex items-center gap-5">
          ...
          <Link
            ...
            onMouseEnter={(e) => { e.currentTarget.style.background = "var(--accent)"; e.currentTarget.style.color = "#000000"; }}
        ...
        <span className="text-sm font-medium" style={{ color: "var(--text-secondary)" }}>Ustawienia</span>
      </header>

      <div className="flex-1 max-w-5xl mx-auto w-full px-4 py-8">
        <h1 className="text-2xl font-bold mb-6" style={{ color: "var(--text-primary)" }}>Ustawienia</h1>
