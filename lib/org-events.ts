...
export interface OrgEvent {
  ...
  required_meta_parameters: string[];
...
const DEFAULT_EVENTS: EventSeed[] = [
  ...
  },
  {
    ...
    required_parameters: ["items", "currency", "value"],
    required_meta_parameters: ["currency", "value"],
  ...
  },
  {
    ...
    required_parameters: ["items", "currency", "value", "transaction_id"],
    required_meta_parameters: ["currency", "value"],
    meta_event: "Purchase",
    tiktok_event: "Purchase",
  },
  {
    event_group: "Ecommerce",
    event_name: "refund",
