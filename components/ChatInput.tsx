      ...
      <form onSubmit={onSubmit} className="flex gap-3 items-end max-w-3xl mx-auto">
        ...
        >
          {isLoading ? (
            ...
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke={canSend ? "#000000" : "var(--text-muted)"} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
